...
public class ShopDAO {
    ...
    private String[] mAllColumns = {DBHelper.COLUMN_SHOP_NAME};
...
/*    public void deleteCompany(Company company) {
    ...
    protected Shop cursorToShop(Cursor cursor) {
        ...
        shop.setName(cursor.getString(cursor.getColumnIndex(DBHelper.COLUMN_SHOP_NAME)));
        shop.setAds(new ArrayList<>());
        shop.setSpacesForAds(new ArrayList<>());
        return shop;
    }
}
